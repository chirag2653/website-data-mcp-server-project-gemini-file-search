...
export interface Website {
    ...
    created_by_ingestion_id: string | null;
    created_at: string;
    updated_at: string;
}
export interface Page {
    ...
    created_by_ingestion_id: string | null;
    created_by_sync_id: string | null;
    last_updated_by_sync_id: string | null;
    firecrawl_batch_id: string | null;
    created_at: string;
    updated_at: string;
}
...
export interface WebsiteInsert {
    ...
    crawl_interval_hours?: number;
    created_by_ingestion_id?: string;
}
...
export interface PageInsert {
    ...
    metadata?: PageMetadata;
    created_by_ingestion_id?: string;
    created_by_sync_id?: string;
    firecrawl_batch_id?: string;
    http_status_code?: number | null;
    firecrawl_scrape_count?: number;
    last_seen?: string;
}
export interface PageUpdate {
    ...
    error_message?: string | null;
    metadata?: PageMetadata;
    last_updated_by_sync_id?: string;
    firecrawl_batch_id?: string;
}
